...
const getMessage = (status: string) => {
  ...
  switch (status) {
    case "PENDING":
      message =
        "You were invited to referee this challenge. Accept or reject it!";
      break;
    case "ACCEPTED":
      message =
        "Great news, you already accepted this challenge so now you can select a winner!";
      break;
    case "REJECTED":
...
const ChallengeRefereeView: FunctionComponent<
  ChallengeRefereeViewProps
> = props => {
  let controls =
    props.challenge.refereeStatus === "PENDING" ? (
  ...
  if (props.challenge.refereeStatus === "ACCEPTED" && !props.challenge.winner) {
    selectOwnerAsWinnerAction = (
      <Button type="button" onClick={props.ownerSelectedAsWinner}>
        Winner
      </Button>
    );
    selectOpponentAsWinnerAction = (
      <Button type="button" onClick={props.opponentSelectedAsWinner}>
        Winner
      </Button>
    );
  }
