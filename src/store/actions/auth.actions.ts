...
export const FetchProfileSuccess = action('FETCH_PROFILE_SUCCESS', payload<any>());
export const FetchProfileFail = action('FETCH_PROFILE_FAIL', payload<any>());
export const FetchProfileNotFound = actionWithoutPayload('FETCH_PROFILE_NOT_FOUND');
