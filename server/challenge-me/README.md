...
This is a sample template for challenge-me - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name challenge-me --query 'Stacks[].Outputs'
```
